"""
Script for extracting commit features that characterize the purpose of the commits.
"""
...
from core.config import repository_branch, repository_path_location, by_tag
